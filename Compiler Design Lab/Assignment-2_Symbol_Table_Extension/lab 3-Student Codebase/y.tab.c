...
{
       0,    59,    59,    62,    63,    64,    65,    69,    73,    74,
      77,    98,   115,   116,   117,   118,   122,   136,   138,   144,
     187,   231,   237,   279,   323,   328,   329,   355,   364,   376,
     377,   378,   379,   380,   381,   387,   387,   390,   391,   394,
     395,   396,   400,   401,   402,   403,   407,   407,   410,   411
};
#endif
...
{
      12,   -27,   -27,   -27,   -27,   -26,    25,   -27,     7,   -21,
       9,    12,     8,   -27,    12,    14,    21,    23,   -27,    12,
     -27,   -27,   -27,   -27,     8,    16,   -25,   -24,   -27,   -27,
      41,     8,    41,   -27,    10,   -27,   -27,   -27,   -27,   -27,
     -27,     8,     8,     8,     8,     8,    23,    31,    16,   -27,
     -27,   -25,   -24,   -24,   -27,   -27,    29,   -27,    -1,    37,
     -27,    48,    41,    49,    35,    -1,    -1,    36,    -1,   -27,
     -27,   -27,   -27,   -27,   -26,   -27,    16,    42,    39,    -1,
     -27,    61,    -1,   -27
};
...
{
     -27,   -27,    58,    34,    54,    53,    47,     0,   -23,    45,
     -10,    -2,   -27,   -27,   -27,   -27,    -6,   -27,   -27,   -27,
     -27
};
...
{
      10,    34,     1,     2,     3,    15,    16,    12,    48,    42,
      43,    10,    44,    45,    10,     1,     2,     3,     4,    10,
      59,    35,    36,    37,    38,    13,     5,    35,    36,    37,
      38,     4,    52,    53,     8,    21,    22,    23,    14,     5,
      19,    60,    54,    55,    76,     8,    24,     9,     8,    50,
      39,    40,    30,     8,    31,    32,    39,    40,     9,    72,
      73,     9,    78,    74,    22,    23,     9,    75,    16,    20,
      56,    57,    29,    81,    24,    67,    83,    33,    71,    69,
      70,    79,    80,    82,    46,    49,    51
};

static const yytype_int8 yycheck[] =
{
       0,    24,     3,     4,     5,    26,    27,    33,    31,    34,
      35,    11,    36,    37,    14,     3,     4,     5,    19,    19,
      21,    11,    12,    13,    14,     0,    27,    11,    12,    13,
      14,    19,    42,    43,     0,    27,    28,    29,    31,    27,
      31,    42,    44,    45,    67,    11,    38,     0,    14,    39,
      40,    41,    38,    19,    33,    32,    40,    41,    11,    65,
      66,    14,    68,    27,    28,    29,    19,    67,    27,    11,
      39,    42,    14,    79,    38,    38,    82,    19,    43,    31,
      31,    39,    43,    22,    30,    32,    41
};
...
#line 77 "parser.y"
				    ...
				    revert variables to default values:value,type
                   	*/
					if(check_symbol_table((yyvsp[-2].value))){
						printf("\033[91mSymbol Table Error\033[0m: %d Variable %s already declared \n",yylineno,(yyvsp[-2].value));
					}
					else{
						symbol* s = allocate_space_for_table_entry((yyvsp[-2].value), size, type_specifier, yylineno, scope);
						int flag = insert_into_table(s);
						if (flag == 0){
							printf("\033[91m Error Inserting into Symbol Table\033[0m: %d \n",yylineno);
						}
						getSymbolTableEntry((yyvsp[-2].value))->val = (yyvsp[0].node_value).value;
					}
...
#line 98 "parser.y"
				...
				finished in lab 2
				*/
				if(check_symbol_table((yyvsp[0].value))==0){
					symbol* s = allocate_space_for_table_entry((yyvsp[0].value), size, type_specifier, yylineno, 1);
					if(!insert_into_table(s)){
						printf("\033[91mSymbol Table Error\033[0m:%s at %d \n",(yyvsp[0].value),yylineno);
					}
				}
				else{
					printf("\033[91mSymbol Table Error\033[0m: %d Variable %s already declared \n",yylineno,(yyvsp[0].value));
				}
			}
#line 1365 "y.tab.c"
    break;
  ...
  case 12: /* TYPE: T_INT  */
#line 115 "parser.y"
                  {type_specifier=2; size=4;}
#line 1371 "y.tab.c"
    break;

  case 13: /* TYPE: T_FLOAT  */
#line 116 "parser.y"
                        {type_specifier=3; size=4;}
#line 1377 "y.tab.c"
    break;

  case 14: /* TYPE: T_DOUBLE  */
#line 117 "parser.y"
                         {type_specifier=4;size=8;}
#line 1383 "y.tab.c"
    break;

  case 15: /* TYPE: T_CHAR  */
#line 118 "parser.y"
                       {type_specifier=1; size=1;}
#line 1389 "y.tab.c"
    break;
...
#line 144 "parser.y"
		...
		/*
          	...
          	*/
		  	if((yyvsp[0].node_value).type == 1){
				printf("\033[91mType Mismatch\033[0m: Lineno %d Got Type %s Expected %s\n",yylineno,type_mappings[(yyvsp[0].node_value).type],type_mappings[(yyvsp[-2].node_value).type]);
			}
			if((yyvsp[-2].node_value).type == 1){
				printf("\033[91mType Mismatch\033[0m: Lineno %d Got type %s Expected %s\n",yylineno,type_mappings[(yyvsp[-2].node_value).type],type_mappings[(yyvsp[0].node_value).type]);
			}

			char * operand1 = (yyvsp[-2].node_value).value;
			char * operand2 = (yyvsp[0].node_value).value;
			...
			(yyval.node_value).value = strdup(buffer);
			// else if($1.type == 2){
...
#line 329 "parser.y"
            	...
            	*/
				...
				if(check_symbol_table((yyvsp[0].value))){
						if(checkDefaultValue((yyvsp[0].value))){
							printf("\033[91mSymbol Table Error\033[0m: %d Variable not initialised %s  \n",yylineno,(yyvsp[0].value));
						}
						else{
							(yyval.node_value).value = strdup(getSymbolTableEntry((yyvsp[0].value))->val);
							(yyval.node_value).type = getSymbolTableEntry((yyvsp[0].value))->type;
							if(getSymbolTableEntry((yyvsp[0].value))->type != (yyval.node_value).type){
								printf("\033[91mType Mismatch\033[0m: Lineno %d Variable %s Expected %s\n",yylineno,(yyvsp[0].value), type_mappings[(yyval.node_value).type]);
							}
							else{
								(yyval.node_value).value = strdup(getSymbolTableEntry((yyvsp[0].value))->val);
							}
...
#line 355 "parser.y"
    		...
    		/*
		        ...
		        (secondary type variable used here)
                */
				(yyval.node_value).value = strdup((yyvsp[0].value));
				(yyval.node_value).type = 4;
			}
#line 1666 "y.tab.c"
    break;
