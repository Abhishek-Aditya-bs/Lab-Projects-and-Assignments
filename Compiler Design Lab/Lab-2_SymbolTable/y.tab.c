...
{
       0,    28,    28,    31,    32,    33,    34,    38,    42,    43,
      46,    47,    71,    72,    73,    74,    78,    81,    82,    85,
      86,    87,    91,    92,    93,    96,    97,    98,    99,   102,
     103,   104,   105,   106,   107,   112,   114,   115,   118,   119,
     120,   124,   125,   128
};
#endif
...
#line 47 "parser.y"
                ...
                */
				// printf("Checking if T_ID is present in table\n");
				 ...
				 if(check_symbol_table(yyvsp[0])==0){
					//  printf("Inserting into empty table\n");
					symbol* s = allocate_space_for_table_entry(yyvsp[0], size, type_specifier, yylineno, 1);
